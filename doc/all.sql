...
insert into `category` (id, parent, name, sort) values (302, 300, '框架应用', 302);
...
insert into `category` (id, parent, name, sort) values (501, 500, '服务器', 502);
...
insert into `doc` (id, ebook_id, parent, name, sort, view_count, vote_count) values (5, 1, 0, '文档3',2, 0,0);
insert into `doc` (id, ebook_id, parent, name, sort, view_count, vote_count) values (6, 1, 5, '文档3.1',1, 0,0);
